...
const PROTIPS_TR = {
  ...
  9: 'Sonsuz scroll = dopamin enflasyonu. Gerçek odaklanmaya düşmanca etkidir.',
...
const PROTIPS_EN = {
  ...
  9: 'Infinite scroll = dopamine inflation. Hostile to real focus.',
...
const QUIZ_TR = {
  ...
  9: [ { q: 'Sonsuz scroll dopamin etkisi?', options: ['Doğal', 'Dopamin enflasyonu', 'Etkisiz', 'Pozitif'], correct: 1, explain: 'Algoritma her saniye ödül verir, baseline çöker.' }, { q: 'Dikkat süresine etkisi?', options: ['Geliştirir', 'Yıkıcı', 'Etkisiz', 'Artırır'], correct: 1, explain: 'Kısa-uyaranlı içerik uzun odaklanmayı imkansızlaştırır.' } ],
...
const QUIZ_EN = {
  ...
  9: [ { q: 'Effect of infinite scroll on dopamine?', options: ['Natural', 'Dopamine inflation', 'No effect', 'Positive'], correct: 1, explain: 'Algorithm rewards every second, baseline collapses.' }, { q: 'Effect on attention span?', options: ['Improves', 'Destructive', 'No effect', 'Increases'], correct: 1, explain: 'Constant short-stimulus content makes long focus impossible.' } ],
